...
<body>
    ...
    <script>
        window.jQuery || document.write('<script src="<?= base_url('jquery-3.2.1.slim.min.js') ?>"><\/script>')
    </script>
    <script src="<?= base_url('popper.min.js') ?>"></script>
    <script src="<?= base_url('bootstrap-4.0.0/dist/js/bootstrap.min.js') ?>"></script>
    <script src="<?= base_url('holder.min.js') ?>"></script>
    <script>
